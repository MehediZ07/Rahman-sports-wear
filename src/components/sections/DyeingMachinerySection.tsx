...
const dyeingTotal = { slNo: "", machines: "", capacity: "", specification: "TOTAL", totalMachines: "12" };
      ...
      <div className="container px-4 mx-auto md:px-8 lg:px-20">
        <div className="grid items-center grid-cols-1 gap-8 lg:grid-cols-2 md:gap-12 lg:gap-16">
          <FadeInUp>
            ...
            <DataTable columns={dyeingColumns} data={dyeingData} totalRow={dyeingTotal} rowHeight="compact" />
          </FadeInUp>
          <FadeInUp delay={0.3}>
            <img
