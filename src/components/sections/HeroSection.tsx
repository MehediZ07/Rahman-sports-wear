...
export const HeroSection = (): JSX.Element => {
  return (
    <section id="hero" className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[700px] bg-gradient-to-r from-white via-white to-transparent">
      ...
      <div className="container relative px-4 py-8 mx-auto z-5 md:px-8 lg:px-20 md:py-12 lg:py-20">
